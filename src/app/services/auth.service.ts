...
export class AuthService {
  ...
  public getCurrentMemberId(force: boolean): Observable<string> {
    return from(this.getToken().then((x: Token) => {
      if (x == null) {
        if (force === true) {
          AuthService.reroute();
        } else {
